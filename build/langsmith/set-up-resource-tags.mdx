...
You can manage resource tags through the [LangSmith UI](https://smith.langchain.com) or programmatically via the [REST API](https://api.smith.langchain.com/redoc):
