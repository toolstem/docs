...
[Fleet](/langsmith/fleet/index), [Insights](/langsmith/insights), and [Polly](/langsmith/polly) require [LangSmith Deployment](#enable-langsmith-deployment) to be enabled first.
...
- `postgres`: Dedicated PostgreSQL instance for the feature's data.
- `redis`: Dedicated Redis instance for the feature's caching and pub/sub.
