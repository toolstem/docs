...
<Info>
Try the new Event Streaming preview for typed projections over messages, state, subgraphs, output, and custom extensions. Start with the [Event Streaming summary](/oss/python/langgraph/streaming/event-streaming), or explore runnable examples in the [streaming cookbook](https://github.com/langchain-ai/streaming-cookbook).
</Info>
