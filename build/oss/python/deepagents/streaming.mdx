...
<Info>
**In preview:** Try event streaming typed Deep Agents projections over coordinator messages, delegated subagents, tool calls, and final output. Start with [Deep Agents Event Streaming](/oss/python/deepagents/event-streaming), or explore runnable examples in the [streaming cookbook](https://github.com/langchain-ai/streaming-cookbook).
</Info>
