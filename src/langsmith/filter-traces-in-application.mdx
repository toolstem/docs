...
1. **Filters**: Located at the top left of the **Tracing** project page. This is where you construct and manage filter criteria.
    ...
    - Quick filter by **Traces** or **Runs**.
...
Click the <Icon icon="ellipsis-vertical"/> icon next to the saved filter in the dropdown, and delete the filter using the trash <Icon icon="trash"/> icon.
